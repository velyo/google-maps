...
namespace Velyo.Google.Map.UI
{
    ...
    public class MarkerImage : IScriptDataConverter
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="Velyo.Google.UI.MarkerImage"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Velyo.Google.UI.MarkerImage"/> to <see cref="System.String"/>.
        /// </summary>
