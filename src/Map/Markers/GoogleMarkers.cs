...
namespace Velyo.Google.Map.UI
{
    ...
    public class GoogleMarkers : DataBoundControl, IExtenderControl, IPostBackEventHandler
    {
        ...
        /// </summary>
        /// <param name="e">The <see cref="Velyo.Google.UI.MarkerEventArgs"/> instance containing the event data.</param>
        protected virtual void OnClickableChanged(MarkerEventArgs e)
        {
            if (ClickableChanged != null) ClickableChanged(this, e);
        }
        ...
        {
            if (DraggableChanged != null) DraggableChanged(this, e);
        }
        ...
        {
            if (FlatChanged != null) FlatChanged(this, e);
        }
        ...
        {
            if (ShadowChanged != null) ShadowChanged(this, e);
        }
        ...
        {
            if (ZIndexChanged != null) ZIndexChanged(this, e);
        }
