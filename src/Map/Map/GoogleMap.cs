...
namespace Velyo.Google.Map.UI
{
    ...
    public class GoogleMap : ScriptControl, IPostBackEventHandler
    {
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="Velyo.Google.UI.BoundsEventArgs" /> instance containing the event data.
        /// </param>
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="Velyo.Google.UI.MouseEventArgs" /> instance containing the event data.
        /// </param>
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="Velyo.Google.UI.MapEventArgs" /> instance containing the event data.
        /// </param>
