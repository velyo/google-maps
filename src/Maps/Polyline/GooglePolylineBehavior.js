...
Velyo.Google.Maps.PolylineBehavior = function (element) {
    Velyo.Google.Maps.PolylineBehavior.initializeBase(this, [element]);
};

Velyo.Google.Maps.PolylineBehavior.prototype = {
    initialize: function () {
        Velyo.Google.Maps.PolylineBehavior.callBaseMethod(this, 'initialize');
        Velyo.Google.Maps.Worker.queue(Function.createDelegate(this, this._attach));
    },
    dispose: function () {
        this._detach();
        Velyo.Google.Maps.PolylineBehavior.callBaseMethod(this, 'dispose');
    }
};
...
(function (proto) {
    ...
    proto.create = function () {
        ...
        var points = Velyo.Google.Maps.Convert.toLatLngArray(this.path);
        var options = {
...
})(Velyo.Google.Maps.PolylineBehavior);

Velyo.Google.Maps.PolylineBehavior.registerClass('Velyo.Google.Maps.PolylineBehavior', Sys.UI.Behavior);
