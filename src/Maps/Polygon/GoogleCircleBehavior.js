...
Velyo.Google.Maps.CircleBehavior = function (element) {
    Velyo.Google.Maps.CircleBehavior.initializeBase(this, [element]);
};

Velyo.Google.Maps.CircleBehavior.prototype = {
    initialize: function () {
        Velyo.Google.Maps.CircleBehavior.callBaseMethod(this, 'initialize');
        Velyo.Google.Maps.Worker.queue(Function.createDelegate(this, this._attach));
    },
    dispose: function () {
        this._detach();
        Velyo.Google.Maps.CircleBehavior.callBaseMethod(this, 'dispose');
    }
};
...
})(Velyo.Google.Maps.CircleBehavior);

Velyo.Google.Maps.CircleBehavior.registerClass('Velyo.Google.Maps.CircleBehavior', Sys.UI.Behavior);
