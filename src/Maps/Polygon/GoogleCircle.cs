...
[assembly: WebResource("Velyo.Google.Maps.Polygon.GoogleCircleBehavior.js", "text/javascript")]
[assembly: WebResource("Velyo.Google.Maps.Polygon.GoogleCircleBehavior.min.js", "text/javascript")]
...
namespace Velyo.Google.Maps
{
    ...
    public class GoogleCircle : Overlay
    {
        ...
        {
            var descriptor = new ScriptBehaviorDescriptor("Velyo.Google.Maps.CircleBehavior", targetControl.ClientID);

            // properties
            descriptor.AddProperty("center", Center.ToScriptData());
            ...
            descriptor.AddProperty("radius", Radius);
            ...
            if (Click != null)
            {
                descriptor.AddEvent("click", "Velyo.Google.Maps.CircleBehavior.raiseServerClick");
            }
            ...
            if (DoubleClick != null)
            {
                descriptor.AddEvent("doubleClick", "Velyo.Google.Maps.CircleBehavior.raiseServerDoubleClick");
            }
            ...
            if (MouseDown != null)
            {
                descriptor.AddEvent("mouseDown", "Velyo.Google.Maps.CircleBehavior.raiseServerMouseDown");
            }
            ...
            if (MouseMove != null)
            {
                descriptor.AddEvent("mouseMove", "Velyo.Google.Maps.CircleBehavior.raiseServerMouseMove");
            }
            ...
            if (MouseOut != null)
            {
                descriptor.AddEvent("mouseOut", "Velyo.Google.Maps.CircleBehavior.raiseServerMouseOut");
            }
            else if (OnClientMouseMove != null)
            {
            ...
            if (MouseOver != null)
            {
                descriptor.AddEvent("mouseOver", "Velyo.Google.Maps.CircleBehavior.raiseServerMouseOver");
            }
            ...
            if (MouseUp != null)
            {
                descriptor.AddEvent("mouseUp", "Velyo.Google.Maps.CircleBehavior.raiseServerMouseUp");
            }
            ...
            if (RightClick != null)
            {
                descriptor.AddEvent("rightClick", "Velyo.Google.Maps.CircleBehavior.raiseServerRightClick");
            }
...
#if DEBUG
            yield return new ScriptReference("Velyo.Google.Maps.Polygon.GoogleCircleBehavior.js", assembly);
#else
            yield return new ScriptReference("Velyo.Google.Maps.Polygon.GoogleCircleBehavior.min.js", assembly);
#endif
        }
