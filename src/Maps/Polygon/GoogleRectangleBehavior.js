...
Velyo.Google.Maps.RectangleBehavior = function (element) {
    Velyo.Google.Maps.RectangleBehavior.initializeBase(this, [element]);
};

Velyo.Google.Maps.RectangleBehavior.prototype = {
    initialize: function () {
        Velyo.Google.Maps.RectangleBehavior.callBaseMethod(this, 'initialize');
        Velyo.Google.Maps.Worker.queue(Function.createDelegate(this, this._attach));
    },
    dispose: function () {
        this._detach();
        Velyo.Google.Maps.RectangleBehavior.callBaseMethod(this, 'dispose');
    }
};
...
(function (proto) {
    ...
    proto.create = function () {
        ...
        var options = {
            bounds: Velyo.Google.Maps.Convert.toLatLngBounds(this.bounds),
...
})(Velyo.Google.Maps.RectangleBehavior);

Velyo.Google.Maps.RectangleBehavior.registerClass('Velyo.Google.Maps.RectangleBehavior', Sys.UI.Behavior);
