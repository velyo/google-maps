...
Velyo.Google.Maps.PolygonBehavior = function (element) {
    Velyo.Google.Maps.PolygonBehavior.initializeBase(this, [element]);
};

Velyo.Google.Maps.PolygonBehavior.prototype = {
    initialize: function () {
        Velyo.Google.Maps.PolygonBehavior.callBaseMethod(this, 'initialize');
        Velyo.Google.Maps.Worker.queue(Function.createDelegate(this, this._attach));
    },
    dispose: function () {
        this._detach();
        Velyo.Google.Maps.PolygonBehavior.callBaseMethod(this, 'dispose');
    }
};
Velyo.Google.Maps.PolygonBehavior.registerClass('Velyo.Google.Maps.PolygonBehavior', Sys.UI.Behavior);
...
(function (proto) {
    ...
    proto.create = function () {
        ...
        var points = Velyo.Google.Maps.Convert.toLatLngArray(this.paths);
        var options = {
...
})(Velyo.Google.Maps.PolygonBehavior);
