...
[assembly: WebResource("Velyo.Google.Maps.Polygon.GoogleRectangleBehavior.js", "text/javascript")]
[assembly: WebResource("Velyo.Google.Maps.Polygon.GoogleRectangleBehavior.min.js", "text/javascript")]
...
namespace Velyo.Google.Maps
{
    ...
    public class GoogleRectangle : Overlay
    {
        ...
        {
            var descriptor = new ScriptBehaviorDescriptor("Velyo.Google.Maps.RectangleBehavior", targetControl.ClientID);
            ...
            if (Click != null)
            {
                descriptor.AddEvent("click", "Velyo.Google.Maps.RectangleBehavior.raiseServerClick");
            }
            ...
            if (DoubleClick != null)
            {
                descriptor.AddEvent("doubleClick", "Velyo.Google.Maps.RectangleBehavior.raiseServerDoubleClick");
            }
            ...
            if (MouseDown != null)
            {
                descriptor.AddEvent("mouseDown", "Velyo.Google.Maps.RectangleBehavior.raiseServerMouseDown");
            }
            ...
            if (MouseMove != null)
            {
                descriptor.AddEvent("mouseMove", "Velyo.Google.Maps.RectangleBehavior.raiseServerMouseMove");
            }
            ...
            if (MouseOut != null)
            {
                descriptor.AddEvent("mouseOut", "Velyo.Google.Maps.RectangleBehavior.raiseServerMouseOut");
            }
            else if (OnClientMouseMove != null)
            {
            ...
            if (MouseOver != null)
            {
                descriptor.AddEvent("mouseOver", "Velyo.Google.Maps.RectangleBehavior.raiseServerMouseOver");
            }
            ...
            if (MouseUp != null)
            {
                descriptor.AddEvent("mouseUp", "Velyo.Google.Maps.RectangleBehavior.raiseServerMouseUp");
            }
            ...
            if (RightClick != null)
            {
                descriptor.AddEvent("rightClick", "Velyo.Google.Maps.RectangleBehavior.raiseServerRightClick");
            }
...
#if DEBUG
            yield return new ScriptReference("Velyo.Google.Maps.Polygon.GoogleRectangleBehavior.js", assembly);
#else
            yield return new ScriptReference("Velyo.Google.Maps.Polygon.GoogleRectangleBehavior.min.js", assembly);
#endif
        }
