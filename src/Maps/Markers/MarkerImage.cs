...
namespace Velyo.Google.Maps
{
    ...
    public class MarkerImage : IScriptDataConverter
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="MarkerImage"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="MarkerImage"/> to <see cref="System.String"/>.
        /// </summary>
