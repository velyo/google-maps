...
[assembly: WebResource("Velyo.Google.Maps.GoogleMap.js", "text/javascript")]
[assembly: WebResource("Velyo.Google.Maps.GoogleMap.min.js", "text/javascript")]
...
namespace Velyo.Google.Maps
{
    ...
    /// 
    /// </summary>
    [Designer("Velyo.Google.Maps.GoogleMapDesigner, Velyo.Google.Maps, Version=6.0.0.0, Culture=neutral, PublicKeyToken=fc8d6190a3aeb01c")]
    ...
    public class GoogleMap : ScriptControl, IPostBackEventHandler
    {
        ...
        {
            var descriptor = new ScriptControlDescriptor("Velyo.Google.Maps.Map", ClientID);
...
#if DEBUG
            yield return new ScriptReference("Velyo.Google.Maps.GoogleMap.js", assembly);
#else
            yield return new ScriptReference("Velyo.Google.Maps.GoogleMap.min.js", assembly);
#endif
        }
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="BoundsEventArgs" /> instance containing the event data.
        /// </param>
        ...
        /// </summary>
        /// <param name="e">
        ///     The <see cref="MapEventArgs" /> instance containing the event data.
        /// </param>
        protected virtual void OnMapTypeChanged(MapEventArgs e)
        {
            MapTypeChanged?.Invoke(this, e);
        }
        ...
        {
            ProjectionChanged?.Invoke(this, e);
        }
