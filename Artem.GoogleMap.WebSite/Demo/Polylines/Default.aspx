<%@ Page Language="C#" MasterPageFile="~/demo/polylines/Master.master" AutoEventWireup="false"
    Inherits="Artem.Google.Web.Demo.Polylines.DefaultPage" CodeBehind="Default.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="main" ID="mainContent" runat="Server">
    ...
    <p>
        ...
        or an image overlay from Google servers otherwise.</p>
    <p>
