<%@ Page Language="C#" MasterPageFile="~/demo/polygons/Master.master" AutoEventWireup="false" Inherits="Artem.Google.Web.Demo.Polygons.DefaultPage" Codebehind="Default.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="main" ID="mainContent" runat="Server">
    ...
    <p>
        ...
        that you can additionally specify a fill color and opacity.</p>
    <p>
