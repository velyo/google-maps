<%@ Page Language="C#" MasterPageFile="~/demo/polygons/Master.master" AutoEventWireup="false" Inherits="Artem.Google.Web.Demo.Polygons.GoogleCirclePolygonPage" Codebehind="GoogleCirclePolygon.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="main" ID="mainContent" runat="Server">
    ...
    <h3>
        Description</h3>
    <p>
        Wraps Google Maps API class GPolygon and extends it to draw circle polygon.</p>
    <p>
