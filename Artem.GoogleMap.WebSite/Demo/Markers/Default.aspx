<%@ Page Language="C#" MasterPageFile="~/demo/markers/Master.master" AutoEventWireup="false" Inherits="Artem.Google.Web.Demo.Markers.DefaultPage" Codebehind="Default.aspx.cs" %>
...
<asp:Content ContentPlaceHolderID="main" ID="mainContent" runat="Server">
    ...
    <p>
        ...
        events and infowindow events.</p>
    <p>
